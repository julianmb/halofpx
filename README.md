...
| **`qwen38-flash-next`** | Qwen 3.8 Flash Next 125B MoE | Next-Gen MoE / Hybrid Attention | `UD-IQ1_S` (67.5G) | **27.3 tok/s** *(measured bring-up)* | **68 GB** | [julianmb/Qwen3.8-Flash-Next-GGUF](https://huggingface.co/julianmb/Qwen3.8-Flash-Next-GGUF) |
