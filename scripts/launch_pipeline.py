#!/usr/bin/env python3
"""Daemonize launcher for the HaloFPX hybrid pipeline (double-fork, fully detached)."""
import os
import sys
import subprocess
...
def main():
    log_path = "/tmp/halofpx_pipeline.log"
    ...
    with open("/tmp/halofpx_pipeline.pid", "w") as f:
