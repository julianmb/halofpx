...
## 4. RAM-Aware Prompt Caching

HaloFPX automatically allocates an additional prompt cache based on physical system RAM:

| System RAM | Prompt Cache | Checkpoints Per Slot |
|---:|---:|---:|
| Under 56 GiB | 8 GiB | 4 |
| 56–111 GiB | 16 GiB | 8 |
| 112+ GiB | 32 GiB | 16 |
