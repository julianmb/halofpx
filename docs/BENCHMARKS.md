...
- **ROCmFP4 verdict: PARKED** — `Q4_0_ROCMFP4_FAST` (63.27 GiB, 4.26 bpw): PPL 7.04 vs 4.61 + incoherent generation; `Q4_0_ROCMFP4_STRIX_LEAN` (63.35 GiB): repetitive garbage. DIAG control (`Q4_K_M` → FAST, 63.27 GiB) fails identically (Chinese loops for math) — breakage is source-independent, not the Q8_0 band path. All gated on fresh servers, load logs clean. NOT published. `Q4_K_M` remains the serving quant.
