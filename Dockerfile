...
RUN mkdir -p /app/engine && \
    curl -L "https://github.com/julianmb/q38rocm/releases/download/${ENGINE_RELEASE}/strix-halo-rocmfpx-engine-v1.5.1-linux-x86_64.tar.gz" -o /tmp/engine.tar.gz && \
